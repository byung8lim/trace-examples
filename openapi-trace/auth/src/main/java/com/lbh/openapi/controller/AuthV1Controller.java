...
//			Tracer tracer = GlobalOpenTelemetry.getTracer("auth-server");
//			span.addEvent("getAllList "+result.toJson());
//			span.end();
//		}
...
//			Span span = Span.current();
//			Tracer tracer = GlobalOpenTelemetry.getTracer("auth-server");
//			span.addEvent("createAppKey "+result.toJson());
//			span.end();
//		}
		return new ResponseEntity<String>(result.toJson(), result.status());
	}
...
//			Span span = Span.current();
//			Tracer tracer = GlobalOpenTelemetry.getTracer("auth-server");
//			span.addEvent("vaildateAppKey "+result.toJson());
//			span.end();
//		}
		return new ResponseEntity<String>(result.toJson(), result.status());
	}
